...
if (scoreJohn > scoreMike && scoreJohn > scoreMary) {
	console.log('John\'s average score is higher. Avg Score: ' + scoreJohn);
} else if (scoreMike > scoreJohn && scoreMike > scoreMary) {
	console.log('Mark\'s average score is higher. Avg Score: ' + scoreMike);
} else if (scoreMary > scoreJohn && scoreMary > scoreMike) {
	console.log('Mary\'s  average score is higher. Avg Score: ' + scoreMary);
} else {
